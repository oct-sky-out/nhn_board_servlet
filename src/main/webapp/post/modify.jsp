...
<fmt:bundle basename="postModify">
<!DOCTYPE html>
...
<head>
    ...
    <title><fmt:message key="post_modify"/></title>
</head>
<body>
                ...
                <div class="is-boxed text-2xl">
                    <label class="w-full">
                        ...
                        <input class="w-full input is-success" type="text"
                               placeholder="<fmt:message key="title_placeholder"/>" name="title" value="${post.getTitle()}">
                    </label>
                </div>
                <div class="is-boxed text-xl">
                    <label>
                        ...
                        <textarea name="content" class="resize-none textarea is-success"
                                  placeholder="<fmt:message key="content_placeholder"/>">${post.getContent()}</textarea>
                    </label>
                </div>
                <div class="is-boxed text-xl flex justify-end">
                    <input class="button is-success" type="submit" value="<fmt:message key="modify"/>">
                </div>
            </div>
        </div>
    </form>
